...
The latter two variables will be a little more complex and take some care to set up. Meanwhile, let's use just the first 3 predictors of age/sex/class and get a sense of how well different machine learning methods do with this relatively simple set of data.
...
```
Next, load up the data itself and orgainse it into a dplyr data table:
